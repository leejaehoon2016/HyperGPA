...
class Base_LSTM(Base):
    def __init__(self, in_dim, out_dim, hidden_dim, num_layers, bidirectional = False, **kargs):
        super().__init__()
        self.in_size = in_dim
        self.GRU = MyLSTM(in_dim, hidden_dim, num_layers = num_layers, batch_first = True, bidirectional = bidirectional)
...
if __name__ == "__main__":
    model = Base_LSTM(1,2,32,2,False)
